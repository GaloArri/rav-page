...
export default function Header() {
  ...
  return (
    <>
      ...
      <div
        className={`h-48 w-full ${currentTheme === "dark" ? "bg-[#222222]" : "bg-[#f7f7f7]"}`}
        aria-hidden="true"
      ></div>
      ...
      <header
        ...
        } ${currentTheme === "dark" ? "bg-[#1a1a1a]/90 text-white" : "bg-[#f7f7f7] text-black"}`}
      >
        ...
        <div
          className={`w-full border-b ${currentTheme === "dark" ? "border-[#333333]" : "border-[#cccccc]"} ${
